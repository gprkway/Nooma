...
export default function Insights() {
  ...
  const insightsSections = [
    { 
      ...
      text: 'Your numbers reveal a period of spiritual growth and transformation...'
    },
    { 
      id: 'zodiac',
      label: 'ZODIAC ALIGNMENT',
      text: 'The stars suggest a time of introspection and renewal...'
    },
    { 
      id: 'elements',
      label: 'ELEMENTAL BALANCE',
      text: 'Your elemental composition indicates a harmonious flow of energy...'
    }
  ];
          ...
          <div className="space-y-8">
            {insightsSections.map((section, index) => (
              <div key={section.id}>
                ...
                {/* Divider */}
                {index < insightsSections.length - 1 && (
